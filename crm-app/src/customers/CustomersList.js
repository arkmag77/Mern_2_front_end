    ...
    return (
        ...
        <div>
            ...
            <div className="PopUpWindow" >
                ...
                <form onSubmit = {(e)=>{console.log("Save btn clicked, customer._id:", customerIdToEdit); validate(e)/* props.editCustomer(e, customerIdToEdit);   setPopUpToEditVisible(false) */ }}>
                    ...
                    <fieldset>
                        ...
                        <span className='NameMessage'>{nameMessage}</span> <br />
                    </fieldset>
                    ...
                    <fieldset>
                        ...
                        <span className='nipMessage'>{nipMessage}</span> <br />
                    </fieldset>
